## 🛠️ Herramientas Utiles


#### 👩‍💻 Dev Tools  (para quienes tengan cancha!)
- [Sublime](https://www.sublimetext.com) - Text & code editor. 
- [Postman](https://www.postman.com/) - Testea API Calls
- [Regex101](https://regex101.com/) - Cheat sheet y testing de Regex
- [JSON Editor Online](https://jsoneditoronline.org/) - Editor y visualizador online de JSON


#### ⌛ Templates y herramientas de productividad
...
#### 🆒 Otras
- [Have I Been Pwned?](https://haveibeenpwned.com/) - Revisa si te hackearon la password de tus cuentas
